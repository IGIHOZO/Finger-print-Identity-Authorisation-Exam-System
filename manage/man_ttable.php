...
<head>
  <meta charset="utf-8">
  <title>Manage Time-Table | Finger-print Identity Authorisation Exam System</title>
  ...
  <link href="../lib/datepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
</head>
...
<center style="margin-top: -30px">
    <h1><u style="text-decoration: underline double">Timetable</u> Management    <label style="font-size: 20px" id="resp"></label></h1>
</center>
 <form class="form-inline" action="/action_page.php">
  <div class="form-group">
    <label for="sel_cls">Select Class:</label>
    <select class="form-control" id="sel_cls" onclick="return chckClassExm()">
      <?php
...
<option <?php if ($i==0){echo "selected='true'";}?> value="<?php echo $ft_sel_cls['class_id']?>"><?php echo $ft_sel_cls['class_name'];?></option>
  ...
  <div class="form-group">
    <label for="chckCrs">&nbsp;&nbsp; Course:</label>
    <select class="form-control" id="chckCrs">
    </select>
  </div>
  <div class="form-group">
    <label for="chckCrs">&nbsp;&nbsp; Date-Time:</label>
    <input type="date" id="chckDay" placeholder="Day" class="form-control">
    <input type="time" id="chckTime" placeholder="Time" class="form-control">
  </div>
  <div class="form-group">
    <label for="chckCrs">&nbsp;&nbsp; End:</label>
    <input type="time" id="chckEndTime" placeholder="Time" class="form-control">
  </div>
  <div class="form-group">
    &nbsp;&nbsp;&nbsp;
    <input type="button" class="btn btn-success" value="Ok, Set" onclick="return regTTble()">
  </div>
</form> 
<div class="card">
        ...
        <div class="table-responsive">
          <div id="tbl_resp">
            ...
            <button style="float: right;color: #f67;text-decoration: underline;" class="btn btn-link" onclick="return resetTTable();">Reset all</button>
          </div>
        </div>
...
<footer class="page-footer font-small indigo">
  ...
  <script src="../lib/datepicker/js/bootstrap-datetimepicker.min.js"></script>
  <script type="text/javascript">
    chckClassExm();   //============================ To Display the first class's ttable at page loading 
  </script>
